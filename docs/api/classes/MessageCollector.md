...
[@thejulianjara/whatsapp.js](../globals.md) / MessageCollector

# Class: MessageCollector

Defined in: [src/utils/MessageCollector.ts:20](https://github.com/TheJulianJara/whatsapp.js/blob/67a623d96a97e10069d62ac1c26e36b59cf0d1fe/src/utils/MessageCollector.ts#L20)
...
> **new MessageCollector**(`client`, `options?`, `eventTypes?`): `MessageCollector`

Defined in: [src/utils/MessageCollector.ts:37](https://github.com/TheJulianJara/whatsapp.js/blob/67a623d96a97e10069d62ac1c26e36b59cf0d1fe/src/utils/MessageCollector.ts#L37)
...
The client instance to collect messages from
...
Event types to listen for (defaults to MESSAGE_RECEIVED and INTERACTION_CREATE)
...
Defined in: [src/utils/MessageCollector.ts:141](https://github.com/TheJulianJara/whatsapp.js/blob/67a623d96a97e10069d62ac1c26e36b59cf0d1fe/src/utils/MessageCollector.ts#L141)
...
A promise that resolves with the collected messages
...
Defined in: [src/utils/MessageCollector.ts:124](https://github.com/TheJulianJara/whatsapp.js/blob/67a623d96a97e10069d62ac1c26e36b59cf0d1fe/src/utils/MessageCollector.ts#L124)
...
true if the timer was reset, false if there was no timer
...
Defined in: [src/utils/MessageCollector.ts:97](https://github.com/TheJulianJara/whatsapp.js/blob/67a623d96a97e10069d62ac1c26e36b59cf0d1fe/src/utils/MessageCollector.ts#L97)
...
> `static` **awaitMessage**(`client`, `filter?`, `time?`, `eventTypes?`): `Promise`\<`any`\>

Defined in: [src/utils/MessageCollector.ts:156](https://github.com/TheJulianJara/whatsapp.js/blob/67a623d96a97e10069d62ac1c26e36b59cf0d1fe/src/utils/MessageCollector.ts#L156)
